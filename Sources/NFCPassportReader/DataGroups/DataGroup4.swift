...
public class DataGroup4: DataGroup {
    ...
    override func parse(_ data: [UInt8]) throws {
        ...
        try parseISO19794_6( data:value )
    }
    
    func parseISO19794_6( data : [UInt8] ) throws {
        // Validate header - 'I', 'I' 'R' 0x00 - 0x49495200
        if data[0] != 0x49 && data[1] != 0x49 && data[2] != 0x52 && data[3] != 0x00 {
            throw NFCPassportReaderError.InvalidResponse
        }
